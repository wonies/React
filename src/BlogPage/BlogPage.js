      ...
      <div className="blog-card">
        <div className="header">
          <div className="title-section">
            <h1 className="main-title">Ninety One</h1>
          </div>
        ...
        <div className="info-section">
          ...
          <p className="business-info">
            ...
            <br />
            <span className="info-text">010-xxx-xxxx</span>
          </p>
          <p className="business-info">
        ...
        <Carousels /> {/* Include your carousel component here */}
        <div className="store_describe">
          모던 현대적인 퓨전음식 술집 지금 까지 경험해보지못한 만나보지못한
          비쥬얼,맛 경험 해보세요
        </div>
